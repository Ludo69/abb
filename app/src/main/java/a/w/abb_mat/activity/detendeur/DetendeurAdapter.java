...
public class DetendeurAdapter extends RecyclerView.Adapter<a.w.abb_mat.activity.detendeur.DetendeurAdapter.RecyclerViewAdapter> {

    private Context context;
    private List<Detendeur> detendeurs;
    private a.w.abb_mat.activity.detendeur.DetendeurAdapter.ItemClickListener itemClickListener;

    public DetendeurAdapter(Context context, List<Detendeur> detendeurs, a.w.abb_mat.activity.detendeur.DetendeurAdapter.ItemClickListener itemClickListener) {
    ...
    @NonNull
    @Override
    public a.w.abb_mat.activity.detendeur.DetendeurAdapter.RecyclerViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_detendeur, parent, false);
        return new a.w.abb_mat.activity.detendeur.DetendeurAdapter.RecyclerViewAdapter(view, itemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull a.w.abb_mat.activity.detendeur.DetendeurAdapter.RecyclerViewAdapter holder, int position) {
    ...
    class RecyclerViewAdapter extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        CardView card_item;
        a.w.abb_mat.activity.detendeur.DetendeurAdapter.ItemClickListener itemClickListener;

        RecyclerViewAdapter(View itemView, a.w.abb_mat.activity.detendeur.DetendeurAdapter.ItemClickListener itemClickListener) {
            super(itemView);
